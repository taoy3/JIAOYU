...
public class UploadUtil
{
    ...
    private UploadUtil()
    {
        mLogin= BaseApplication.getApplication().getLogin();
    }
    ...
    private void toUploadFile(File file, String fileKey, String RequestURL, Map<String,String> param)
    {
        ...
        try
        {
            ...
            conn.setRequestProperty("Cookie", "JSESSIONID="+mLogin.getSessionId());//设置sessionid,在登录接口获取sessionid
