...
public class RefreshListView extends ListView
        implements AbsListView.OnScrollListener, android.widget.AdapterView.OnItemClickListener {
...
//        ivArrow = (ImageView) mHeaderView.findViewById(R.id.iv_Arrow);
        pbProgress = (ProgressBar) mHeaderView.findViewById(R.id.pb_refresh);
    ...
    private void initFooterView() {
        ...
        tv_load_more = (TextView) mFooterView.findViewById(R.id.tv_load_more);
