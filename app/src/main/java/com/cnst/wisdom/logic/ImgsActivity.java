...
import com.cnst.wisdom.ui.activity.PublishDynamicFmActivity;
...
public class ImgsActivity extends Activity
{
    ...
    com.cnst.wisdom.logic.ImgsAdapter imgsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        locallist = util.listAlldir();
        imgGridView = (GridView)findViewById(R.id.gridView1);
        //        fileTraversal = locallist.get(2);
        //        bundle = getIntent().getExtras();
        //        fileTraversal = bundle.getParcelable("data");

        imgsAdapter = new com.cnst.wisdom.logic.ImgsAdapter(this, locallist, onItemClickClass);
    ...
    {
        Log.e("indexindex", index+"fsdgsdfsdfse"+filepath);
    ...
    com.cnst.wisdom.logic.ImgsAdapter.OnItemClickClass onItemClickClass = new ImgsAdapter.OnItemClickClass()
    {
        @Override
        public void OnItemClick(View v, int Position, CheckBox checkBox)
        {
            ...
            }else
            {
                ...
                {
                    Toast.makeText(ImgsActivity.this, "最多选择9张图片", Toast.LENGTH_SHORT).show();
                    return;
                }
                try
                {
